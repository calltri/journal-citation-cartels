...
if __name__ == "__main__":
    ...
    return DISTINCT toInteger(jsrc.JournalId) as source, toInteger(jtrg.JournalId) as target, toInteger(trg.PaperId) as p_target, toInteger(src.PaperId) as s_target
    """ % (
        yf,
        yf,
        ys,
