...
def load_valid_cartel(year, cartel_dir):
    """Loads a cartel for a given year, returning None if none are there"""
...
# python workflow/plot-all-cartels.py data/cartels data/figs 2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 2010 2011 2012 2013 2014 2015 2016 2017 2018
if __name__ == '__main__':
    ...
    for year in YEARS:
        ...
        for cid, cartel in citation_group_table.groupby("group_id"):
            ...
            plt.savefig("{root}/{year}-cartel-plots.png".format(root=PLOT_DIR, year=year))