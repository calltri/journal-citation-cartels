import construct_yearly_networks
import subprocess
...
if __name__ == "__main__":
    ...
    for year in YEARS:
        ...
        subprocess.Popen(['python3', 'workflow/construct_yearly_networks.py', 'data/networks/paper_count_journals.csv', 'data/journal_networks', '2011', '9999', 'data/journal_networks/raw-nodes-2011.csv', 'data/journal_networks/raw-edges-2011.csv'])
